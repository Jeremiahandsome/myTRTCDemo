...
private slots :
    ...
    void on_btnStartBgmMix_clicked();
    ...
    void on_btnCustomAudioRender_clicked();
...
public:
	...
	TRTCAudioFrame* renderAudioFrame;
private:
...
private:
    ...
    bool isCustomAudioRenderOpen = false;
	bool stopCustomAudioRender = true;
	int buffer_size = (20 * 48000 / 1000) * (1 * 16 / 8);
